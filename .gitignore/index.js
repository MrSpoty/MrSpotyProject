...
client.on('ready', () => {
  client.user.setGame("?help | AntaBot", 'https://www.twitch.tv/AntalyaBotByOKman65');
  console.log("          █████╗ ███╗   ██╗████████╗ █████╗ ██████╗  ██████╗ ████████╗    ██╗   ██╗ ██╗ ██╗  ██╗ ███████╗")
  console.log("         ██╔══██╗████╗  ██║╚══██╔══╝██╔══██╗██╔══██╗██╔═══██╗╚══██╔══╝    ██║   ██║███║ ██║  ██║ ╚════██║")
  console.log("         ███████║██╔██╗ ██║   ██║   ███████║██████╔╝██║   ██║   ██║       ██║   ██║╚██║ ███████║     ██╔╝")
  console.log("         ██╔══██║██║╚██╗██║   ██║   ██╔══██║██╔══██╗██║   ██║   ██║       ╚██╗ ██╔╝ ██║ ╚════██║    ██╔╝ ")
...
client.on('message', message => {
  ...
  if (message.content === prefix2 + "help") {
    message.reply("Les commande s'éxecute avec \"** " + prefix + " **\". Merci")
      .then(msg => {
        msg.delete(5000)
      });
  }
  ...
  if (message.content === prefix2 + "helpmodo") {
    message.reply("Les commande s'éxecute avec \"** " + prefix + " **\". Merci")
      .then(msg => {
        msg.delete(5000)
      });
  ...
  if (message.content === prefix2 + "report") {
    message.reply("Les commande s'éxecute avec \"** " + prefix + " **\". Merci")
      .then(msg => {
        msg.delete(5000)
      });
  ...
  if (message.content === prefix2 + "info") {
    message.reply("Les commande s'éxecute avec \"** " + prefix + " **\". Merci")
      .then(msg => {
        msg.delete(5000)
      });
  ...
  if (message.content === prefix2 + "warn") {
    message.reply("Les commande s'éxecute avec \"** " + prefix + " **\". Merci")
      .then(msg => {
        msg.delete(5000)
      });
  ...
  if (message.content === prefix2 + "unwarn") {
    message.reply("Les commande s'éxecute avec \"** " + prefix + " **\". Merci")
      .then(msg => {
        msg.delete(5000)
      });
...
client.on("message", async message => {
  ...
  if (command === "warn") {
    ...
    let rolemodo = message.guild.roles.find(r => r.name === "(/Staff/)");
